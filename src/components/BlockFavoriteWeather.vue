...
export default {
   ...
   methods: {
        ...mapMutations({
         ...
         removeFavoriteWeatherBlock: 'weather/removeFavoriteWeatherBlock',
        }),
        ...
        removeBlock() {
         ...
         this.removeFavoriteWeatherBlock({ idBlock:this.idBlock, favoriteWeather: this.favoritesWeatherCityDays, favoriteCities: this.favoritesWeatherCities})
        },
        showModalDelete() {
